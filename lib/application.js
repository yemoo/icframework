...
var APP = {
    ...
    _getCtrlInstance: function(fileName) {
        ...
        if (!(fileName in controllerRegistry)) {
            ...
            if (fs.existsSync(filePath)) {
                ...
                // set Name property for Controller
                controller.fileName = fileName;
                instance = instancectrl(controller);
            }
    ...
    makeCallback: function(instance, action, item) {
        ...
        return function(req, res, next) {
            ...
            //instance.__controller__ = controller;
            instance.__action__ = action;
            // init state for instance
            instance.__defaultFormat__ = 'html';
