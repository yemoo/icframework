...
var security = {
    ...
    init: function(req, res, next) {
        ...
        ['params', 'query', 'body', 'cookie', 'signedCookies'].forEach(function(name) {
            ...
            if (params) {
                Object.keys(params).forEach(function(key) {
                    params[this._clean_input_keys(key)] = this._clean_input_data(params[key]);
                }, this);
            }
        }, this);
        ...
        if (this.is_secure) {
            ...
            next(new Error(this.errInfo || 'Security Error!'));
            this.is_secure = true;
            this.errInfo = null;
        }
    },
    _clean_input_keys: function(str) {
        ...
        if (!/^[a-z0-9:_\/-]+$/i.test(str)) {
            ...
            this.errInfo = 'Disallowed Key Characters: ' + str;
        }
    ...
    _clean_input_data: function(data) {
        ...
        if (typeof data == 'object') {
            Object.keys(data).forEach(function(key) {
                data[this._clean_input_keys(key)] = this._clean_input_data(data[key]);
            }, this);
            return data;
        }
